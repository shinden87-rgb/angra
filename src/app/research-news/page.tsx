...
import { Layout, ExternalLink, Calendar, Newspaper, ArrowRight, ArrowLeft, Filter } from 'lucide-react';
...
export default function ResearchNewsPage() {
    ...
    useEffect(() => {
        if (selectedCategory === 'All') {
            ...
            setFilteredNews(news.filter(item => (item.category || 'Other') === selectedCategory));
        }
